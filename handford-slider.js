...
resize() {
      this.scrollPosition = ((this.currentSlide -1) * (this.slideContainer.getBoundingClientRect().width + this.slideMargin)) * -1
...
function debounce(a,b,c){var d;return function(){var e=this,f=arguments;clearTimeout(d),d=setTimeout(function(){d=null,c||a.apply(e,f)},b),c&&!d&&a.apply(e,f)}}
  ...
  window.addEventListener('resize', debounce(()=>{workSlider.resize()}, 100))
